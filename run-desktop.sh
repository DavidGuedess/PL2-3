...
if [ -z "$USER_COUNT" ] || [ "$USER_COUNT" = "0" ]; then
    ...
    echo ""
    echo -e "      ${GRAY}  ADM001 / password123  — Admin    — David Guedes${NC}"
    echo -e "      ${GRAY}  ADM002 / password123  — Admin    — Xavier Bolotinha${NC}"
    echo -e "      ${GRAY}  GER001 / password123  — Manager  — Leonardo Andronési${NC}"
    echo -e "      ${GRAY}  GER002 / password123  — Manager  — Diogo Silva${NC}"
    echo -e "      ${GRAY}  EMP001 / password123  — Employee — Mariana Ferreira${NC}"
